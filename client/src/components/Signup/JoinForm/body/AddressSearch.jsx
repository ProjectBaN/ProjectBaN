  ...
  return (
    <div className="absolute">
      <div className="w-full h-full fixed left-0 top-0  text-center bg-[#ececec] md:w-full md:h-full md:bg-[#ececec]/0  ">
        <div className=" w-full h-14 flex justify-center items-center fixed left-0 right-0 text-white bg-[#4a5164]  m-auto md:w-AddressWindthContainer md:fixed md:left-0 md:right-0 md:top-DaumPostCodeHeader ">
